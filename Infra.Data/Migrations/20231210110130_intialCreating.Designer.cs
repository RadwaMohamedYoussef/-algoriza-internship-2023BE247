...
namespace Infra.Data.Migrations
{
    ...
    [Migration("20231210110130_intialCreating")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Models.Appointment", b =>
                {
                    ...
                    b.Property<string>("DoctorDetailsId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");

                    b.Property<string>("PatientDetailsId")
                        .IsRequired()
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Domain.Models.AppointmentTime", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Domain.Models.DoctorDetails", b =>
                {
                    ...
                    b.HasDiscriminator().HasValue("DoctorDetails");
                });

            modelBuilder.Entity("Domain.Models.PatientDetails", b =>
                {
                    b.HasBaseType("API.Models.ApplicationUser");
                    ...
                    b.HasDiscriminator().HasValue("PatientDetails");
                });

            modelBuilder.Entity("Domain.Models.Appointment", b =>
                {
                    b.HasOne("Domain.Models.DoctorDetails", "DoctorDetails")
                        .WithMany("Appointments")
                        .HasForeignKey("DoctorDetailsId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Domain.Models.PatientDetails", "PatientDetails")
                        .WithMany("Appointments")
